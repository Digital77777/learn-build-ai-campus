...
const AIToolsPage = () => {
  ...
  const categories = ["All", "Development", "Creative", "Analytics", "Communication", "Research", "Machine Learning"];
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Powered by the latest AI models and machine learning algorithms
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Intuitive interfaces designed for both beginners and experts
              </p>
            </div>
          </div>
        </div>
